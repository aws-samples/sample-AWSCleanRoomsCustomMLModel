...
- [Use Case: Customer Purchase Propensity Scoring](#use-case-customer-purchase-propensity-scoring)
...
- [Appendix](#appendix)
  ...
  - [Optional Step: Amazon SageMaker AI Direct Training](#optional-step-amazon-sagemaker-ai-direct-training)
...
## Use Case: Customer Purchase Propensity Scoring
...
This section covers the 6 steps required to deploy the complete demo. Each step is a single Python script that you run from the project root. All scripts are idempotent: if a resource has already been created, the script reuses it rather than failing or creating a duplicate. Hence you can re-run any step safely, whether you're resuming an interrupted deployment or simply re-applying a configuration change.
...
**Script:** `scripts/codebuild_containers.py`
...
### Optional Step: Amazon SageMaker AI Direct Training
...
**Script:** `scripts/build_and_push.py`
